...
var __gwtModuleFunction = $wnd.electronicbattlemat;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.electronicbattlemat=");
    idx += (13 + "electronicbattlemat".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=electronicbattlemat-0.js
